...
namespace SistemaVisitas.Migrations
{
    ...
    [Migration("20230604223139_usuarios-x2")]
    partial class usuariosx2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SistemaVisitas.Models.Visita", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "UsuarioAnulacion")
                        .WithMany()
                        .HasForeignKey("IdUsuarioAnulacion");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "UsuarioAtencion")
                        .WithMany()
